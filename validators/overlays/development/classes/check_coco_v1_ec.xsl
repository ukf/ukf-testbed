        ...
        <xsl:choose>
            ...
            <!--OK
                ...
                1.4. For all mdui elements, at least an English version of the element MUST be available,
                     indicated by an xml:lang="en"attribute.
            -->
            <xsl:when test="md:SPSSODescriptor/md:Extensions[mdui:UIInfo/mdui:DisplayName[not(@xml:lang='en')]]">
                <xsl:call-template name="error">
                    <xsl:with-param name="m">
            ...
            <!--
                ...
                1.4. For all mdui elements, at least an English version of the element MUST be available,
                     indicated by an xml:lang="en"attribute.
            -->
            <xsl:when test="md:SPSSODescriptor/md:Extensions[mdui:UIInfo/mdui:Description[not(@xml:lang='en')]]">
                <xsl:call-template name="error">
                    <xsl:with-param name="m">
